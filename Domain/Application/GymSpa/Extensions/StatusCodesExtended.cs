namespace Domain.Application.GymSpa.Extensions
{
    public static class StatusCodesExtended
    {
        ...
        public const int Status209Cancelled = 209;
        public const int Status210NotCancelled = 210;
        public const int Status211Updated = 211;
        public const int Status212Deleted = 212;
        ...
        public const int Status411NotCreated = 411;
        public const int Status412NotSent = 412;
        public const int Status413Unsessful = 413;
        public const int Status99Exception = 99;
        public const int Status410InvalidObject = 410;
        //public const   int SUCCESS = "00";
        //public const   int NOT_PROCESSED = "01";
        //public const   int UNSUCCESSFUL = "02";
        //public const   int INSUFFICIENT_BAL = "03";
        //public const   int INSUFFICIENT_INFO = "04";
        //public const   int INVALID_ENTRY = "05";
        //public const   int HASH_MISMATCH = "09";
